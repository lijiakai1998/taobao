...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name="alipayment" action=${pageContext.request.contextPath}/admin/insert1 method=post target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" readonly="readonly" value="${dingdanhao}" />
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<c:forEach items="${goods}" var="good">
							<input id="WIDsubject" name="WIDsubject" value="${good.gName}" readonly="readonly" type="hidden" />
							<a>${good.gName}</a>
						</c:forEach>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${sessionScope.get("total1")}" readonly="readonly"  />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="mm" name="mm" value="一共买了${sessionScope.get("selectTotal")}件" readonly="readonly"  />
					</dd>
					<dt>购买详情：</dt>
					<dd>
						...
						<c:forEach items="${count}" var="count">
							<a>&nbsp&nbsp x${count}&nbsp&nbsp&nbsp&nbsp</a>
						</c:forEach>
					</dd>
					<dd>
						<input id="WIDbody" name="WIDbody" value="11" type="hidden">
					</dd>
					<%--<dd>--%>
						<%--<input id="uid" name="uid" value="${sessionScope.get("uid")}" type="hidden">--%>
					<%--</dd>--%>
					<%--<dd>--%>
						<%--<input id="dShuliang" name="dShuliang" value="${sessionScope.get("selectTotal1")}" type="hidden">--%>
					<%--</dd>--%>
					<%--<dd>--%>
						<%--<input id="dJine" name="dJine" value="${goods.gPrice}" type="hidden">--%>
					<%--</dd>--%>
					<%--<dd>--%>
						<%--<input id="dZhuangtai" name="dZhuangtai" value="0" type="hidden">--%>
					<%--</dd>&ndash;%&gt;--%>
